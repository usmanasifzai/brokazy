...
function Achievement(props) {
  return (
    <Svg
      ...
      <Path
        fill="#D0401B"
        d="M144.83 306.61L296.28 280.53 360 429.51 281.2 428.61 216.45 481.14z"
      />
      <Path
        fill="#F60"
        d="M231.94 290.08L69.57 294.38 0 459.86 78.8 458.95 143.55 511.48z"
      />
      <Path
        fill="#F5C800"
      ...
      <Path
        fill="#E37E00"
        fillRule="nonzero"
        d="M185.78 116.08l16.31 38.19 41.36 3.71c1.83.16 3.18 1.77 3.02 3.59-.07.89-.49 1.67-1.12 2.21l-31.29 27.33 9.26 40.5c.41 1.79-.71 3.57-2.5 3.98-.92.21-1.83.02-2.56-.45l-35.55-21.26-35.66 21.32a3.32 3.32 0 01-4.94-3.59l9.26-40.5-31.3-27.33a3.311 3.311 0 01-.31-4.68c.61-.7 1.46-1.08 2.32-1.13l41.26-3.7 16.32-38.21a3.311 3.311 0 014.35-1.75c.84.35 1.45 1 1.77 1.77z"
      />
    </Svg>
  );
}
